...
def user_professional_category():
    ...
    st.selectbox('Please, specify your professional category:', ('Government Official', 'Program Implementer/Practitioner', 'Researcher'), key="professional_category")
...
SUBTITLE_INSTRUCTIONS = '''This example is designed to help you understanding the survey question format and how to effectively respond to inquiries about the outcomes of participating in the SCINERGY '24 Pilot.\\
